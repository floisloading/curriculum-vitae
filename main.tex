...
\begin{minipage}[t]{0.4\textwidth} % 40% of the page width for the introduction text
	\vspace{-\baselineskip} % Required for vertically aligning minipages
  I am a professional web-developer, trainer and technology consultant. I'm curious about stying up to date with the latest tech-stuff.
  I think and act Agile because I truly believe in the power of a self-organised team and intrinsic motivation. The benefits to the users
  are my motivation. Let's build awesome products together!\\
  \begin{quotation}
