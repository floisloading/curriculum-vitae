...
\begin{minipage}[t]{0.45\textwidth} % 45% of the page width for name
	...
	{\huge Consultant \& Trainer for Web Frontend Technologies} % Career or current job title
\end{minipage}
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the first row of icons
	...
	\icon{At}{12}{\href{mailto:moin@frot.io}{moin@frot.io}}\\	
\end{minipage}
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the second row of icons
	...
	% The first parameter is the FontAwesome icon name, the second is the box size and the third is the text
	% Other icons can be found by referring to fontawesome.pdf (supplied with the template) and using the word after \fa in the command for the icon you want
	\icon{Globe}{12}{\href{https://frot.io}{frot.io}}\\
	\icon{Github}{12}{\href{https://github.com/frot-io}{github.com/frot-io}}\\
	\icon{Twitter}{12}{\href{https://twitter.com/@frot\_io}{@frot\_io}}\\
	\icon{StackOverflow}{12}{\href{https://stackoverflow.com/story/frot-io}{stackoverflow.com/story/frot-io}}\\
\end{minipage}
...
\begin{center}
	\bubbles{5/Design Thinking, 4/REST, 6/Scrum, 3/TDD, 6/git}
\end{center}
