...
\begin{minipage}[t]{0.45\textwidth} % 45% of the page width for name
	...
	{\includegraphics[scale=0.57]{logo.png}} % Career or current job title
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth} % 40% of the page width for the introduction text
	\vspace{-\baselineskip} % Required for vertically aligning minipages
  I am a professional technology consultant, trainer and % \href{https://www.remoteonly.org/}{\uline{remote-first}} TODO: write blopost why remote-first
  ...
  \begin{quotation} % TODO: neither emph, nor textit nor itshape are working...
...
\begin{entrylist}
  \entry
    ...
    {
      Implementing an Agent Interface for Customer Relationship Management for the ABOUT YOU Cloud.\\
      \texttt{VueJS}\slashsep\texttt{Bootstrap}\slashsep\texttt{Vuex}\slashsep
    }
	\entry
    ...
    {
      Designing and implementing a \textbf{Progressive Web App} for mobile use. The app allows a user to build his/her own calendar by
      marking events as favorite. \textbf{Push-Notifications} are sent when an an event is rescheduled. The project is non-profit and
      available on \uline{\href{https://github.com/frot-io/ramstein-conference-app}{Github}}.\\
  ...
  \entry
		...
		{Deutsche Telekom AG}
    {
      ...
      \href{https://www.telekom.de/zuhause/geraete-und-zubehoer/smart-speaker}{Smart Speaker}, we provided a webinterface for a team
      of Linguists. I also organised \textbf{Retrospectives} and Design Thinking.\\
  ...
  \entry
		{8/2016 -- 3/2018\\\footnotesize{part time}}
		{Trainer}
		{Opitz Consulting}
		{
  ...
  \entry
		...
		{
      Designing and implementing a system for data-handling in complex container-logistics, introducing \textbf{agile development} and 
      we created \textbf{npm-Packages} for Authentication and Validation.\\ 
