...
\begin{minipage}[t]{0.4\textwidth} % 40% of the page width for the introduction text
  ...
  I think and act Agile, Design Thinking\\
...
\begin{entrylist}
		...
		{\href{https://www.ramstein-kampagne.eu/}{Stopp Air Base Ramstein Campaign}}
    {
      ...
      See \underline{\href{https://ramstein-conference-app.herokuapp.com/}{ramstein-conference-app.herokuapp.com}} for a live demo.\\
      \smallskip
  ...
  \entry
		...
		{Deutsche Telekom AG}
    {
      Developing a web-application to model and modify complex language models. As part of the team \textbf{Machine Learning} in the project
      ...
      of Linguists and Editors with which they could train the model to better understand the consumer. I also organised \textbf{Retrospectives}.\\
  ...
  \entry
      ...
      as well as training experienced programmers in special use-cases (e.g. \textbf{Reactive Programming}).\\
  ...
  \entry
		...
		{
      Developing complex view components for the comdirect website. We also extended the \textbf{Living Styleguide} and
      deployed it in a \textbf{microservice} architecture.\\
      \texttt{JS}\slashsep\texttt{jQuery}\slashsep\texttt{JSP}\slashsep\texttt{Atomic Design}\slashsep\texttt{BEM}
    }
  \entry
		{7/2016 -- 8/2017}
		{Project lead}
		{Comdirect Bank AG (via Opitz Consulting)}
		{
      Designing and developing a \textbf{Proof of Concept} Webapp for financial planning. As a team of two, we took care of
  ...
  \entry
		...
		{
      Coaching teachers in the use of Wordpress (Posting, Theming, Plugins) for the school's homepage\\
      \texttt{Wordpress}
    }
  \entry
		{9/2014 -- 6/2015}
		...
		{
      Developing a framwork for content-publishing to iPhone-Apps via Cloud-Services\\
  ...
  \entry
		...
		{e.solutions GmbH}
		{
      Developing and testing a car infotainment system on Android-Tablets\\
  ...
  \entry
		...
		{
      Implementing the introduction of Windows 7\\
...
\begin{minipage}[t]{0.3\textwidth}
	...
	I go Snowboarding and cycling on a regular basis. I also love cooking and already gave cooking classes.
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
	\vspace{-\baselineskip} % Required for vertically aligning minipages
  ...
  I'm an active member of the Foodsharing-Movement. Together with my girlfriend, I support HOPAD, an orphanage in Kathmandu, Nepal.
  % and am climate aware. I want to make the world a better place TODO
\end{minipage}
