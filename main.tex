...
\begin{entrylist}
  \entry
		...
		{\href{https://www.ramstein-kampagne.eu/}{Stopp Air Base Ramstein Campaign}}
    {
      ...
      \uline{\href{https://github.com/frot-io/ramstein-conference-app}{open-source}}.\\
  ...
  \entry
		...
		{Deutsche Telekom AG, \href{https://www.telekom.de/zuhause/geraete-und-zubehoer/smart-speaker}{Magenta Smart Speaker}}
    {
      ...
      \textbf{Machine Learning} team, using Design Thinking organising \textbf{Retrospectives}.\\
  ...
  \entry
		...
		{Opitz Consulting}
		{
      Teaching web-technologies for beginners (e.g. how \textbf{SPA}s work) as well as experienced programmers (e.g. \textbf{RxJS}).\\
