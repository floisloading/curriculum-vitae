...
\begin{minipage}[t]{0.45\textwidth} % 45% of the page width for name
	...
	{\includegraphics[scale=0.25]{logo.png} \huge Frontend Technologies} % Career or current job title
\end{minipage}
...
\begin{minipage}[t]{0.4\textwidth} % 40% of the page width for the introduction text
	\vspace{-\baselineskip} % Required for vertically aligning minipages
  I am a professional web-developer, trainer and technology consultant. I'm curious about staying up to date with the latest tech-stuff.
...
\begin{entrylist}
  ...
  \entry
		...
		{Deutsche Telekom AG}
    {
      ...
      \textit{\href{https://www.telekom.de/zuhause/geraete-und-zubehoer/smart-speaker}{Smart Speaker}}, we provided an interface for a team
...
\begin{minipage}[t]{0.3\textwidth}
  ...
  goal is to become a meditation teacher.
\end{minipage}
\hfill
\begin{minipage}[t]{0.3\textwidth}
	\vspace{-\baselineskip} % Required for vertically aligning minipages
  ...
  and am a huge fan of the Effective Altruism movement.
\end{minipage}
